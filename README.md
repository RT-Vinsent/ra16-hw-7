## **`!РЕШЕНО! «HOC — Higher Order Components». Все задачи`**  
...
[![Build status](https://ci.appveyor.com/api/projects/status/uiiup5wi6792ejp2?svg=true)](https://ci.appveyor.com/project/RT-Vinsent/ra16-hw-7)
